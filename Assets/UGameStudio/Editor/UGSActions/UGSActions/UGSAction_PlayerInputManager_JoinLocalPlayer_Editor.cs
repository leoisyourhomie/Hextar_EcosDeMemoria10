namespace UGSSpace
{
    namespace UGameActions
    {
        ...
        public class UGSAction_PlayerInputManager_JoinLocalPlayer_Editor : UGSAction_Editor
        {
            UGSAction_PlayerInputManager_JoinLocalPlayer thisAction;
            ...
            public override string NameInBuilderList_Spanish => "Unir Jugador Local";

            public override string NameInBuilderList_English => "Join Local Player";

            public override string NameInEditor_Spanish => "Unir Jugador Local";

            public override string NameInEditor_English => "Join Local Player";

            public override string DescriptionSpanish => "Unir Jugador Local";

            public override string DescriptionEnglish => "Join Local Player";
            ...
            {
                if (thisAction == null)
                    thisAction = (UGSAction_PlayerInputManager_JoinLocalPlayer)_action;

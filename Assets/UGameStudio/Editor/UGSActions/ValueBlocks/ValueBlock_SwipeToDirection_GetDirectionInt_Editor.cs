namespace UGSSpace
{
    ...
    public class ValueBlock_Input_SwipeToDirection_GetDirectionInt_Editor : FunctionsEditor.ValueBlockEditor
    {
        public override bool IsThisBlockAssigned => block != null;
        public override int Order => 0;

        public override string NameInBuilderList_Spanish => "Swipe hacia dirección (Int)";

        public override string NameInBuilderList_English => "Swipe To Direction (Int)";
        ...
        private ValueBlock_Input_SwipeToDirection_GetDirectionInt block;
        ...
        {
            block ??= (ValueBlock_Input_SwipeToDirection_GetDirectionInt)_valueBlock;

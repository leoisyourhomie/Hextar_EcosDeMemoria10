namespace UGSSpace
{
    ...
    public class ValueBlock_Input_SwipeToDirection_Editor : FunctionsEditor.ValueBlockEditor
    {
        public override int Order => 0;

        public override bool IsThisBlockAssigned => block != null;

        public override string NameInBuilderList_Spanish => "Swipe hacia dirección (Trigger)";

        public override string NameInBuilderList_English => "Swipe To Direction (Trigger)";

        public override string NameInEditor_Spanish => "Deslizar hacia";
        ...
        private ValueBlock_Input_SwipeToDirection block;
        ...
        {
            block ??= (ValueBlock_Input_SwipeToDirection)_valueBlock;

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedInt_Editor : FunctionsEditor.ValueBlockEditor
    {
        ...
        public override string NameInBuilderList_Spanish => "Input From Player Is Detected (Int)";

        public override string NameInBuilderList_English => "Input From Player Is Detected (Int)";
        ...
        public override string DescriptionSpanish => "Input From Player Is Detected (Int)";

        public override string DescriptionEnglish => "Input From Player Is Detected (Int)";
        ...
        ValueBlock_Input_InputFromPlayerIsDetectedInt block;
        ...
        {
            block ??= (ValueBlock_Input_InputFromPlayerIsDetectedInt)_valueBlock;

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedFloat_Editor : FunctionsEditor.ValueBlockEditor
    {
        ...
        public override string NameInBuilderList_Spanish => "Input From Player Is Detected (Float)";

        public override string NameInBuilderList_English => "Input From Player Is Detected (Float)";
        ...
        public override string DescriptionSpanish => "Input From Player Is Detected (Float)";

        public override string DescriptionEnglish => "Input From Player Is Detected (Float)";
        ...
        ValueBlock_Input_InputFromPlayerIsDetectedFloat block;
        public override void Draw(FlowEditor flowEditor, ActionsReactivity actionsReactivity, ValueBlock _valueBlock, bool disableSelectionForSpecificObjectsInScene, List<IUGameVariable> receivedLocalVariables, bool isThisFieldInsideValueSelectorWindow)
        {
            ...
            {
                block ??= (ValueBlock_Input_InputFromPlayerIsDetectedFloat)_valueBlock;

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_CustomInputIsDetectedVector2_Editor : FunctionsEditor.ValueBlockEditor
    {
        public override bool IsThisBlockAssigned => block != null;
        public override int Order => 0;

        public override string NameInBuilderList_Spanish => "Custom Input Is Detected (Vector2) ";

        public override string NameInBuilderList_English => "Custom Input Is Detected (Vector2) ";

        public override string NameInEditor_Spanish => "Input Personalizado";

        public override string NameInEditor_English => "Custom Input";

        public override string DescriptionSpanish => "Custom Input Is Detected (Vector2) ";

        public override string DescriptionEnglish => "Custom Input Is Detected (Vector2) ";
        ...
        ValueBlock_Input_CustomInputIsDetectedVector2 block;
        public override void Draw(FlowEditor flowEditor, ActionsReactivity actionsReactivity, ValueBlock _valueBlock, bool disableSelectionForSpecificObjectsInScene, List<IUGameVariable> receivedLocalVariables, bool isThisFieldInsideValueSelectorWindow)
        {
            ...
            {
                block ??= (ValueBlock_Input_CustomInputIsDetectedVector2)_valueBlock;

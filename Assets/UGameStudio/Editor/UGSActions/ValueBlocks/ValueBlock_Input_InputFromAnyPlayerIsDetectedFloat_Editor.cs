namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromAnyPlayerIsDetectedFloat_Editor : FunctionsEditor.ValueBlockEditor
    {
        public override bool IsThisBlockAssigned => block != null;
        public override int Order => 0;

        public override string NameInBuilderList_Spanish => "Input From Any Player Is Detected (Float)";

        public override string NameInBuilderList_English => "Input From Any Player Is Detected (Float)";
        ...
        public override string DescriptionSpanish => "Input From Any Player Is Detected (Float)";

        public override string DescriptionEnglish => "Input From Any Player Is Detected (Float)";
        ...
        ValueBlock_Input_InputFromAnyPlayerIsDetectedFloat block;
        public override void Draw(FlowEditor flowEditor, ActionsReactivity actionsReactivity, ValueBlock _valueBlock, bool disableSelectionForSpecificObjectsInScene, List<IUGameVariable> receivedLocalVariables, bool isThisFieldInsideValueSelectorWindow)
        {
            ...
            {
                block ??= (ValueBlock_Input_InputFromAnyPlayerIsDetectedFloat)_valueBlock;

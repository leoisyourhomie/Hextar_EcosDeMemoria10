namespace UGSSpace
{
    ...
    public class ValueBlock_Input_CustomInputIsDetectedTrigger_Editor : FunctionsEditor.ValueBlockEditor
    {
        public override bool IsThisBlockAssigned => block != null;
        public override int Order => 0;

        public override string NameInBuilderList_Spanish => "Custom Input Is Detected (Trigger)";

        public override string NameInBuilderList_English => "Custom Input Is Detected (Trigger)";

        public override string NameInEditor_Spanish => "Input Personalizado";

        public override string NameInEditor_English => "Custom Input";

        public override string DescriptionSpanish => "Custom Input Is Detected (Trigger)";

        public override string DescriptionEnglish => "Custom Input Is Detected (Trigger)";
        ...
        ValueBlock_Input_CustomInputIsDetectedTrigger block;
        public override void Draw(FlowEditor flowEditor, ActionsReactivity actionsReactivity, ValueBlock _valueBlock, bool disableSelectionForSpecificObjectsInScene, List<IUGameVariable> receivedLocalVariables, bool isThisFieldInsideValueSelectorWindow)
        {
            ...
            {
                block ??= (ValueBlock_Input_CustomInputIsDetectedTrigger)_valueBlock;

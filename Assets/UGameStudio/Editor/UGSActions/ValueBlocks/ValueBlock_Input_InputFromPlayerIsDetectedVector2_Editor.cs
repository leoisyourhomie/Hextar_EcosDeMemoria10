namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedVector2_Editor : FunctionsEditor.ValueBlockEditor
    {
        ...
        public override string NameInBuilderList_Spanish => "Input From Player Is Detected (Vector2)";

        public override string NameInBuilderList_English => "Input From Player Is Detected (Vector2)";
        ...
        public override string DescriptionSpanish => "Input From Player Is Detected (Vector2)";

        public override string DescriptionEnglish => "Input From Player Is Detected (Vector2)";
        ...
        ValueBlock_Input_InputFromPlayerIsDetectedVector2 block;
        ...
        {
            block ??= (ValueBlock_Input_InputFromPlayerIsDetectedVector2)_valueBlock;

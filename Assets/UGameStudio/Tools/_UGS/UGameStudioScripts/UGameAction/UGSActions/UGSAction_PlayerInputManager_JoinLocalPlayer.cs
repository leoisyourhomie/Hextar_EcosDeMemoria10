namespace UGSSpace
{
    namespace UGameActions
    {
        ...
        [Serializable]
        public class UGSAction_PlayerInputManager_JoinLocalPlayer : UGSActionNormal
        {
            ...
            {
                UGSAction_PlayerInputManager_JoinLocalPlayer ugsAction = (UGSAction_PlayerInputManager_JoinLocalPlayer)this.MemberwiseClone();
            ...
            protected override void Action()
            {
                ...
                currentPlayerInputManager.JoinPlayer();
            }
        }
    }
}

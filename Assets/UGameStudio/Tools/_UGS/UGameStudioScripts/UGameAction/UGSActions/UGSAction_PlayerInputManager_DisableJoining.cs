namespace UGSSpace
{
    namespace UGameActions
    {
        ...
        [Serializable]
        public class UGSAction_PlayerInputManager_DisableJoining : UGSActionNormal
        {
            ...
            {
                UGSAction_PlayerInputManager_DisableJoining ugsAction = (UGSAction_PlayerInputManager_DisableJoining)this.MemberwiseClone();
            ...
            protected override void Action()
            {
                ...
                if (currentPlayerInputManager.joiningEnabled)
                {
                    currentPlayerInputManager.DisableJoining();
                    UGameEvents.OnJoiningEnableChangedInPlayerInputManager?.Invoke();
                }
            }
        }
    }

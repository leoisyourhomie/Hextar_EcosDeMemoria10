namespace UGSSpace
{
    namespace UGameActions
    {
        ...
        [Serializable]
        public class UGSAction_PlayerInput_ActivateInput : UGSActionNormal
        {
            ...
            {
                UGSAction_PlayerInput_ActivateInput ugsAction = (UGSAction_PlayerInput_ActivateInput)this.MemberwiseClone();

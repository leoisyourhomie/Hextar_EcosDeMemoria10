namespace UGSSpace
{
    namespace UGameActions
    {
        ...
        [Serializable]
        public class UGSAction_PlayerInputManager_EnableJoining : UGSActionNormal
        {
            ...
            {
                UGSAction_PlayerInputManager_EnableJoining ugsAction = (UGSAction_PlayerInputManager_EnableJoining)this.MemberwiseClone();

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_CustomInputIsDetectedFloat : ValueBlock.GenericValueBlock<float>
    {
        public ValueBlock_Input_CustomInputIsDetectedFloat() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_CustomInputIsDetectedFloat thisCopy = (ValueBlock_Input_CustomInputIsDetectedFloat)this.MemberwiseClone();

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedInt : ValueBlock.GenericValueBlock<int>
    {
        public ValueBlock_Input_InputFromPlayerIsDetectedInt() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_InputFromPlayerIsDetectedInt thisCopy = (ValueBlock_Input_InputFromPlayerIsDetectedInt)this.MemberwiseClone();

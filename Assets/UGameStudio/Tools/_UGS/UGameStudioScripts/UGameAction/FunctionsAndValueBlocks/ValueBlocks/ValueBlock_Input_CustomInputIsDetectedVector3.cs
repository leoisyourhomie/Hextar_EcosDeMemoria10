namespace UGSSpace
{
    ...
    public enum InputReactionTypeEnum
    {
        OnPerformed,
        OnStarted,
        OnCanceled,
        OnPerformedOrCanceled,
        OnPerformedOrStarted,
        OnStartedOrCanceled,
        OnPerformedOrStartedOrCanceled
    }

    public class ValueBlock_Input_CustomInputIsDetectedVector3 : ValueBlock.GenericValueBlock<Vector3>
    {
        public ValueBlock_Input_CustomInputIsDetectedVector3() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_CustomInputIsDetectedVector3 thisCopy = (ValueBlock_Input_CustomInputIsDetectedVector3)this.MemberwiseClone();

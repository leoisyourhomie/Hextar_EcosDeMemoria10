namespace UGSSpace
{
    ...
    public class ValueBlock_Input_CustomInputIsDetectedTrigger : ValueBlock.GenericValueBlock<Trigger>
    {
        public ValueBlock_Input_CustomInputIsDetectedTrigger() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_CustomInputIsDetectedTrigger thisCopy = (ValueBlock_Input_CustomInputIsDetectedTrigger)this.MemberwiseClone();

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_CurrentActionMapName : ValueBlock.GenericValueBlock<string>
    {
        public ValueBlock_Input_CurrentActionMapName() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        public override void StartReactiveBehavior()
        {
            ...
            {
                UGameEvents.OnInputActionMapChanged += OnControlsChanged;
            }
        ...
        void UpdateName()
        {
            ...
            {
                if (currentPlayerInput.currentActionMap == null)
                {
                    currentName = "";
                }
                else
                {
                    currentName = currentPlayerInput.currentActionMap.name;
                }
            }
            else
            {

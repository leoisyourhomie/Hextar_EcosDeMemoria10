namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromAnyPlayerIsDetectedInt : ValueBlock.GenericValueBlock<int>
    {
        public ValueBlock_Input_InputFromAnyPlayerIsDetectedInt() : base(ReactiveBehavior.Reactive, false)
        {
        }
        //--------------------------------------------------------------
        ...
        {
            ValueBlock_Input_InputFromAnyPlayerIsDetectedInt thisCopy = (ValueBlock_Input_InputFromAnyPlayerIsDetectedInt)this.MemberwiseClone();
            return thisCopy;
        }

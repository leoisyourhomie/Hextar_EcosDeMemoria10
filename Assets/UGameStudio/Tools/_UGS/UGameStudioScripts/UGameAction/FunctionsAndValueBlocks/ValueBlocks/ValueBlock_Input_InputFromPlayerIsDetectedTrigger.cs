namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedTrigger : ValueBlock.GenericValueBlock<Trigger>
    {
        public ValueBlock_Input_InputFromPlayerIsDetectedTrigger() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_InputFromPlayerIsDetectedTrigger thisCopy = (ValueBlock_Input_InputFromPlayerIsDetectedTrigger)this.MemberwiseClone();
        ...
        private void OnRequiredPlayerInputChange()
        {
            ...
            //If the selector is reactive, then we need to call OnReact

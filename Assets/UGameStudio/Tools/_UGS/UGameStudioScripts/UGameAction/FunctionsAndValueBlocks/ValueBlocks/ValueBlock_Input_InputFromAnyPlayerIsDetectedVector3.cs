namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromAnyPlayerIsDetectedVector3 : ValueBlock.GenericValueBlock<Vector3>
    {
        public ValueBlock_Input_InputFromAnyPlayerIsDetectedVector3() : base(ReactiveBehavior.Reactive, false)
        {
        }
        ...
        {
            ValueBlock_Input_InputFromAnyPlayerIsDetectedVector3 thisCopy = (ValueBlock_Input_InputFromAnyPlayerIsDetectedVector3)this.MemberwiseClone();
            return thisCopy;
        }

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_SwipeToDirection_GetDirectionVector2 : ValueBlock.GenericValueBlock<Vector2>
    {
        public ValueBlock_Input_SwipeToDirection_GetDirectionVector2() : base(ReactiveBehavior.Reactive, false) {}

        //--------------------------------------------------------------
        //The ValueBlock Value (This is the value that will be used in the function or condition)
        protected override Vector2 GetValue() => currentValue;
        //--------------------------------------------------------------
        ...
        {
            ValueBlock_Input_SwipeToDirection_GetDirectionVector2 thisCopy = (ValueBlock_Input_SwipeToDirection_GetDirectionVector2)this.MemberwiseClone();

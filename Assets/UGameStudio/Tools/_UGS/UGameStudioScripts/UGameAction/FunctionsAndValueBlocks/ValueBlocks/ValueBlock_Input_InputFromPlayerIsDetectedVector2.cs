namespace UGSSpace
{
    ...
    public class ValueBlock_Input_InputFromPlayerIsDetectedVector2 : ValueBlock.GenericValueBlock<Vector2>
    {
        public ValueBlock_Input_InputFromPlayerIsDetectedVector2() : base(ReactiveBehavior.Reactive, false) { }
        ...
        {
            ValueBlock_Input_InputFromPlayerIsDetectedVector2 thisCopy = (ValueBlock_Input_InputFromPlayerIsDetectedVector2)this.MemberwiseClone();

namespace UGSSpace
{
    ...
    public class ValueBlock_Input_DefaultActionMapName : ValueBlock.GenericValueBlock<string>
    {
        public ValueBlock_Input_DefaultActionMapName() : base(ReactiveBehavior.NonReactiveAnchoredToItsProperties, true)
        {
        }
        ...
        {
            ValueBlock_Input_DefaultActionMapName thisCopy = (ValueBlock_Input_DefaultActionMapName)this.MemberwiseClone();
        ...
        void UpdateName()
        {
            ...
            if(currentPlayerInput != null)
                currentName = currentPlayerInput.defaultActionMap;
            else
                currentName = "";
        }

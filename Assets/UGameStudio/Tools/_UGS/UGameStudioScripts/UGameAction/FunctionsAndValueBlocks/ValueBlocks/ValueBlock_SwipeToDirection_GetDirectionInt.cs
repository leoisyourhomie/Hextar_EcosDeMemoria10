namespace UGSSpace
{
    ...
    public class ValueBlock_Input_SwipeToDirection_GetDirectionInt : ValueBlock.GenericValueBlock<int>
    {
        public ValueBlock_Input_SwipeToDirection_GetDirectionInt() : base(ReactiveBehavior.Reactive, false) { }
        //--------------------------------------------------------------
        //The ValueBlock Value (This is the value that will be used in the function or condition)
        protected override int GetValue() => currentValue;
        //--------------------------------------------------------------
        ...
        {
            ValueBlock_Input_SwipeToDirection_GetDirectionInt thisCopy = (ValueBlock_Input_SwipeToDirection_GetDirectionInt)this.MemberwiseClone();
        ...
        private void DetectSwipe(InputAction.CallbackContext context)
        {
            ...
            if (direction != Vector2.zero && ReactAs == ReactiveBehavior.Reactive)
            {
                ...
                if (directionEnum.HasValue)
                {
                    ...
                    currentValue = (int)directionEnum.Value;
                    OnReact?.Invoke();
                    currentValue = -1;
                }

...
{
    [Serializable]
    public class ListOfCostumesCategories
    {
        public int Index;
    }
}
...
#if UNITY_EDITOR
[CustomPropertyDrawer(typeof(ListOfCostumesCategories))]
class ListOfCostumesCategoriesDrawer : PropertyDrawer
{
	//private readonly int[] primes = {0, 1, 2};
	private readonly string[] listToShow;
	
    public ListOfCostumesCategoriesDrawer()
    {
        listToShow = UGameStudioGDK.Utilities.Costumes.GetCategoryNames();
    }

...
namespace Expiria3DSpace
{
    public static class MindARImagePlugin
    {
        ...
        public static event Action onErrorAction;

        private static class Native
        {
            [DllImport("__Internal")]
            public static extern void MindARImage_SetCallbacks(Action onARReady, Action onCameraConfigChange, OnARUpdateEvent onARUpdate, Action onError);
...
#if UNITY_EDITOR
#else
            Native.MindARImage_SetCallbacks(OnARReady, OnCameraConfigChange, OnARUpdate, OnError);
#endif
        }

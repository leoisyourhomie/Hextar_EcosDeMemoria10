...
namespace Expiria3DSpace.World
{
    ...
    {
        [HideInInspector] public Vector2 placementOffset = new Vector2();
    ...
    public partial class WorldTracker : MonoBehaviour
    {
        ...
        [SerializeField] public Settings3DOF s3dof = new Settings3DOF();
        [SerializeField] public Settings3DOFOrbit s3dof_orbit = new Settings3DOFOrbit();
        [SerializeField] public Settings6DOF s6dof = new Settings6DOF();
        ...
        [HideInInspector]
        [SerializeField] public PlacementIndicatorSettings placementIndicatorSettings = new PlacementIndicatorSettings();
        ...
        void UpdatePlacementIndicator()
        {
            ...
            {
                //trackerCamera.cam.backgroundColor = Color.clear; //set transparent background when the camera is working
                //Debug.Log("hit!");
            ...
            else
            {
                ...
                //This was commented because Emiliano phone shows the camera, but, the indicator was not visible.
                //So, we need to show the indicator always! even if there is no hit.
                ...
                //Debug.Log("Placement indicator disabled because no hit");

                //trackerCamera.cam.backgroundColor = Color.white; //set white background instead black. We use black only when the camera is working, but, in this point of the code, the camera is not working. Showing white background looks better.
            }
        }
